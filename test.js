...
describe('named-appoint', function () {
  it('named constructor and then', function (done) {
    var getUsername = new Promise(function username(resolve, reject) {
      setTimeout(() => {
        resolve('nswbmw')
      })
    })
  ...
  it('named promise with value through', function (done) {
    var getUsername = new Promise(function username(resolve, reject) {
      setTimeout(() => {
        resolve('nswbmw')
      })
  ...
  it('named catch', function (done) {
    ...
    getUsername
      ...
      .catch((_, username, user) => {
        assert(username === 'nswbmw')
        assert(user instanceof Error)
        done()
      })
  })
});